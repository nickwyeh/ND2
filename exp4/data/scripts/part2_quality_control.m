%% Quality Control Datafor Experiment 4 (for additional details see OSF, https://osf.io/y9h2c)

% Overview : This script performs some quality control checks for Expt. 4. 
% This follows the pre-registered criteria found on OSF for Experiment 4. 
% In addition the participant log is updated. This script will output study+ test data
% to the data analysis folder and an updated participant log. 


% Required to run this script:
% 1) Must run the part1_organize script before this.
% 2) Raw data folder on OSF 
% 3) Matlab toolbox from https://github.com/koenlab/koenlab_tools
% 4) Participant log in raw folder (part 1_organize output)

% Quality control checks to identify good/bad data:
...
% Step 1: Get participant list to analyze
% Step 2: Gather Participant ID and make directories
% Step 3: load data and set up
% Step 4: Compute the proportion of excluded study trials < .2
% Step 5: Compute the proportion of excluded test trials < .2
% Step 6: compute item pr < .1
% Step 7: Compute Source memory pR on good trials
% Step 8: Proportion of Confidence Bin 2-5 Use >=.1
% Step 9: Determine if good or bad
% Step 10: Save the combined participant log to data files folder for part3_analyze.m script
%% Clear workspace
clear all;
clc;
