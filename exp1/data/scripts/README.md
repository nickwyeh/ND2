#### The scripts need to be run in order: organization script (Part1) -> quality control script (Part2) -> analyses script (Part3). The individual scripts contain additional details.
