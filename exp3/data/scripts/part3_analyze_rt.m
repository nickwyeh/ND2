...
%     cr_s_high_uncued             = (hit_s_high_uncued - source_fa_high_uncued);
 %% Check study judgment accuracy (reviewer comments)
    ...
    uncued_study = mean(study_hit(old_trial & good_study_trial & uncued & good_rt_trial));
    ...
    hit_fa_data = vertcat(hit_fa_data, ...
     ...
     memory_acc_data = vertcat(memory_acc_data, ...
        ...
        {participant status study_cb list 'uncued' uncued_auc uncued_cor_recog uncued_Ro uncued_F   cr_s_uncued uncued_sourcePR p_shit_uncued p_sdk_uncued} );
    ...
    study_rt_data = vertcat(study_rt_data, ...
        ...
        { participant status study_cb list 'uninformed'  'SC'   median(study_rts(uninformed & old_trial & old_resp & source_cor & good_trial & good_rt_trial)) }, ...
        { participant status study_cb list 'uninformed'  'SIDK' median(study_rts(uninformed & old_trial & old_resp & source_miss & good_trial & good_rt_trial)) }, ...
        { participant status study_cb list 'uninformed'  'Miss' median(study_rts(uninformed & old_trial & ~old_resp & good_trial & good_rt_trial)) },...
        { participant status study_cb list 'uncued'  'SC'   median(study_rts(uncued & old_trial & old_resp & source_cor & good_trial & good_rt_trial)) }, ...
        { participant status study_cb list 'uncued'  'SIDK' median(study_rts(uncued & old_trial & old_resp & source_miss & good_trial & good_rt_trial)) }, ...
        { participant status study_cb list 'uncued'  'Miss' median(study_rts(uncued & old_trial & ~old_resp  & good_trial & good_rt_trial)) } );
