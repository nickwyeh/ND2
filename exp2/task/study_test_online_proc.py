...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Nick\\Desktop\\nick\\nd002\\pilot2_exp2\\study_test_online_proc.py',
...
stimuli_cb_options = [1,2,3,4,5,6,7,8]
shuffle(stimuli_cb_options)

stimuli_cb_options[0]

print(stimuli_cb_options[0])

if stimuli_cb_options[0] == 1:
    phase_file = 'List1_study_cbA_phases.csv'
elif stimuli_cb_options[0] ==2:
    phase_file = 'List1_study_cbB_phases.csv'
elif stimuli_cb_options[0] ==3:
    phase_file = 'List2_study_cbA_phases.csv'
elif stimuli_cb_options[0] ==4:
    phase_file = 'List2_study_cbB_phases.csv'
elif stimuli_cb_options[0] == 5:
    phase_file = 'List3_study_cbA_phases.csv'
elif stimuli_cb_options[0] ==6:
    phase_file = 'List3_study_cbB_phases.csv'
elif stimuli_cb_options[0] ==7:
    phase_file = 'List4_study_cbA_phases.csv'
elif stimuli_cb_options[0] ==8:
    phase_file = 'List4_study_cbB_phases.csv'
else:
    print("you broke me")
